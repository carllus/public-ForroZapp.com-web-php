...
var isMobile = {
	...
	if ( isMobile.Android() ) {
		...
		//window.location.replace("https://play.google.com/store/apps/details?id=aplicativoforrozapp.meuforroapp.android");
    }
	...
	{
//computador
		//window.location.replace("http://meuforroapp.com/");		
		//window.location.replace("http://www.windowsphone.com/pt-pt/store/app/forr%C3%B3zapp-meuforr%C3%B3app-com-br/d603930c-1a2b-4b1a-8873-875fe18cd90d");
	}
