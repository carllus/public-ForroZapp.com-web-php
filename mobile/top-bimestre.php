...
{
	$redirect = "http://forrozapp.com.br/simulador/baixados.php";
...
// Conexao com o banco de dados PARA DESTAQUES
    ...
    $sql = "SELECT SQL_CACHE * FROM cds WHERE data BETWEEN CURDATE() - INTERVAL 60 DAY AND CURDATE() ORDER BY downs DESC LIMIT 100";
