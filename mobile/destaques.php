...
<div class="tudo">
    ...
    <div class="menu">
	    <a href="javascript:void(0)" onClick="abre('destaques.php','_parent')" title="Destaques">
        ...
        <a href="javascript:void(0)" onClick="abre('recentes.php','_parent')" title="Mais Recentes">
